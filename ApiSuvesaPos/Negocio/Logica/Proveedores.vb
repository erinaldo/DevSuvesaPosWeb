Namespace Logica
    Public Class Proveedores
        ...
        Public Function Buscar(nombre As String) As List(Of Modelo.proveedores)
        ...
        Public Sub Crear(proveedor As Modelo.proveedores)
        ...
        Public Sub Editar(proveedor As Modelo.proveedores)
        ...
        Public Sub Eliminar(proveedor As Modelo.proveedores)
        ...
        Public Function ComprasPendientes(codigoProv As String) As List(Of Modelo.compras)
