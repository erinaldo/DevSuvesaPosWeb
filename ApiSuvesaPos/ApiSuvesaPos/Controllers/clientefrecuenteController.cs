...
namespace ApiSuvesaPos.Controllers
{
    ...
    [Route("[controller]")]
    public class clientefrecuenteController : Controller
    {


        private Negocio.Logica.Clientes_frecuentes db = new Negocio.Logica.Clientes_frecuentes();
        ...
        [HttpPost]
        public IActionResult Registrar(Datos.Models.ClientesFrecuente cliente)
        {
            try
            {
        ...
        [HttpPut]
        public IActionResult Actualizar(int id, Datos.Models.ClientesFrecuente cliente)
        {
            try
            {
