...
namespace ApiSuvesaPos.Controllers
{
    ...
    public class perfilController : Controller
    {
        ...
        private Negocio.Logica.Perfil db = new Negocio.Logica.Perfil();
        ...
        [HttpPost]
        public IActionResult Registrar(Datos.Models.Perfil perfil)
        {
            try
            {
                string resp = db.Crear(perfil);
        ...
        [HttpPut]
        public IActionResult Actualizar(int id, Datos.Models.Perfil perfil)
        {
            try
            {

                string resp = db.Editar(id, perfil);
                double test;
                if (double.TryParse(resp, out test))// Si el resultado es numerico
                {
                    if (test > 0)//Si el resultado es mayor que cero
