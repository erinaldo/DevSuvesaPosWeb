...
namespace ApiSuvesaPos.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class nomagController : Controller
    {

        private Negocio.Logica.NoMAG db = new Negocio.Logica.NoMAG();
        ...
        [HttpPost]
        public IActionResult Registrar(Datos.Models.NoMag nomag)
        {
            try
            {
                string resp = db.Crear(nomag);
